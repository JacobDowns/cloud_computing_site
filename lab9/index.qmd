...
6.  Inside the new `location` map, add the nested fields:
    ...
    -   Name: `lat` \| Type: `number` \| Value: `46.7`
    -   Name: `lng` \| Type: `number` \| Value: `-113.7`
7.  Click **Save**.
...
gcloud firestore databases delete geology-vault --quiet

# Delete the Bucket (and all images inside)
gcloud storage buckets delete gs://[YOUR-PROJECT]-specimen-vault
```
