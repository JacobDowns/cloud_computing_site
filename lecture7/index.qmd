...
**The Result:** When you run this, Docker download uses a base Ubuntu image with Python installed, copies your specific file, and executes it in a completely isolated environment. Now, let's look at the full list of commands available to us.
...
Writing the Dockerfile is the first step. Now you havew to build it.
