...
-   **The "Signed URL" Way (Professional):** You keep the bucket **private**. No one can see the files except your App Engine code (using its Service Account badge). Your code then generates a temporary "VIP pass" (Signed URL) for the user's browser. **We will use this method for our demo.**
