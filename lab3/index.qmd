...
-   **Origin:** Your copy on GitHub `github.com/your-name/partially_cloudy`
    -   You have read/write access here.
-   **Upstream:** The original class repo `github.com/Cloud-Course-Spring-2026/partially_cloudy`
    -   You usually only have read access here.
:::
...
3.  **Commit:** `git commit -m "Add yourname to the list of contributors"`
4.  **Push:**
    ```bash
...
1.  Once your PR has a comment, **raise your hand**.
2.  I will review the "Queue" on the projector.
3.  Watch as your PR changes from **Open** (Green) to **Merged** (Purple).
:::
...
Okay, let's pause here to make sure everyone completed these first steps. 
