...
4.  **Static vs. SPAs**: Where does the code run?
5.  **Load Balancers**: The "Invisible Infrastructure"
6.  **Reference**: Common Codes & Methods
:::
...
*Tip: If you see `* * *`, that just means a router is configured to be "secret" and ignore trace requests.*
:::
