---
title: "Lecture 6 — GitHub Actions"
---
...
::: {.callout-note collapse="false"}
## system.ini — What is GitHub Actions?
...
::: {.callout-note collapse="false"}
## standard_lib.dll — Common Actions
...
## Part 4: Example B — The Python Calculator (CI)
...
::: {.callout-important collapse="false"}
## pipeline.yaml — The CI Configuration
...
3.  GitHub marks the Commit as "Failed" (❌).

::: {.callout-tip collapse="false"}
## fix_loop.gif — What do I do when it fails?
...
## Part 5: Example C — Artifacts

::: {.callout-warning collapse="false"}
## memory_dump.bin — The Vanishing Files
...
::: {.callout-warning collapse="false"}
## system_limits.cfg — The Constraints
...
::: {.callout-tip collapse="false"}
## competitors.csv — The Alternatives
...
::: {.callout-note collapse="false"}
## taskmgr.exe — Managing the Robots
...
-   **The Status Icons:**
    -   ✅ **Green Check:** Success.
    -   ❌ **Red X:** Failure (The robot crashed).
    -   🟡 **Yellow Circle:** Running or Waiting.
    -   ⚪ **Grey:** Skipped or Cancelled.
...
::: {.callout-important collapse="false"}
## debug.log — How to fix a broken build
